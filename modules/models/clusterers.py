...
class IDEC(_AbstractDEC):
    ...
    input.
    """
    def __init__(self, X, autoencoder, n_clusters, gamma=0.1, delta=1.,
                 model_tag=None, initial_centroids=None, labels=None,
                 optimizer=Adam()):
        """Instatiate an IDEC.
        ...
        Args:
            ...
            - delta:        a float, scaling factor controlling how much the
                            autoencoder loss will contribute to the embedding.
                            Setting this value to 0 is equivalent to run a DEC
                            model.
    ...
    def build(self, X, autoencoder, encoder):
        ...
        model.compile(
            ...
            loss_weights=[self.gamma, self.delta]
        )
        ...
        for ite in range(int(maxiter)):
            ...
            if ite % update_interval == 0:
                ...
                if delta < tol:
                    tol_counter += 1
                temp_pred_last = np.copy(temp_pred)
                if ite > 0 and tol_counter > epochs_tol:
